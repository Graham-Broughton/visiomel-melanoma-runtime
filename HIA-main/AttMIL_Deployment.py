...
parser.add_argument(
    '--adressExp', type=str, default=r"L:\Experiments\DACHS_RESNET50_TestFull.txt", help='Adress to the experiment File'
)
parser.add_argument(
    '--modelAdr',
    type=str,
...
if __name__ == '__main__':
    ...
    for targetLabel in targetLabels:
        ...
        model, input_size = utils.Initialize_model(
            model_name=args.model_name, num_classes=args.num_classes, feature_extract=False, use_pretrained=True
        )
        params = {'batch_size': args.batch_size, 'shuffle': True, 'num_workers': 0, 'pin_memory': False}
