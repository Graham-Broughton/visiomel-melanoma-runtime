...
def get_transformation(patch_size=224, mean=None, std=None):
    '''
    ...
    return {
        'train': transforms.Compose(
            [
                ...
                transforms.ColorJitter(
                    brightness=0.35, contrast=0.5, saturation=0.1, hue=0.16
                ),
        ...
        'predict': transforms.Compose([transforms.Normalize(mean, std)]),
