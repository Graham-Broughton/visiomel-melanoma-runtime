...
def get_slide(slide_name):
    ...
    """
    # try:
    slide = pyvips.Image.new_from_file(f'{SRC_TRAIN_DIR}/{slide_name}.{SLIDE_EXT}', page=BASE_PAGE, access='sequential')
...
def small_to_large_mapping(small_pixel, TARGET_PAGE=0):
    ...
    TARGET = (BASE_PAGE - TARGET_PAGE)
    SCALE_FACTOR = 2 ** TARGET
